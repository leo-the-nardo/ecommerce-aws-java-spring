...
VALUES ('Maria Brown', 'maria@gmail.com', '988888888', '$2a$10$eACCYoNOHEqXve8aIWT8Nu3PkMXWBaOxJ9aORUYzfMQCbVBIhZ8tG',
        '2001-07-25');
INSERT INTO tb_user (name, email, phone, password, birth_date)
...
INSERT INTO tb_order (moment, status, client_id)
VALUES ('2022-07-29 15:50:00', 3, 2);
INSERT INTO tb_order (moment, status, client_id)
VALUES ('2022-08-03 14:20:00', 0, 1);

-- For tb_order_item table
